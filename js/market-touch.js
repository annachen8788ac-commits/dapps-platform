...
chart.addEventListener('touchend',e=>{const tapPoint=lastCenter||startPoint,wasTap=!gesture&&!dragging&&e.touches.length===0;if(dragging&&lastCenter)mouse('mouseup',lastCenter.x,lastCenter.y);if(e.touches.length<2)startDistance=0;if(e.touches.length===0){dragging=false;lastCenter=null;startPoint=null;gesture=null;if(wasTap&&tapPoint)showDetail(tapPoint)}},{passive:true});
