...
const MICRO_CADENCE=5000;
const SWITCH_SETTLE=3000;
...
const microDefs=[
 ['[data-best-bid]','market-micro-bid'],['[data-best-ask]','market-micro-ask'],['[data-bid-depth]','market-micro-bid'],['[data-ask-depth]','market-micro-ask'],['[data-vwap]','market-micro-neutral'],['[data-feed-health]','market-micro-health'],['[data-micro-updated]','market-micro-time']
];
const micro=[];
...
function resetMicro(){const until=Date.now()+SWITCH_SETTLE;micro.forEach(st=>{st.acceptAfter=until;st.lastText='';st.lastNumber=null;st.view.textContent='—';st.view.classList.remove('market-data-up','market-data-down','market-data-tick')})}
